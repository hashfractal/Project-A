...
public class Stage1BossAI : MonoBehaviour
{
    ...
    public float Boss1Pattern1Speed = 2;
    public float Boss1Pattern2Speed = 4;
    public float Boss1Pattern1Damage = 20;
    public float Boss1Pattern2Damage = 15;
    ...
    private void Shoot16()
    {
        ...
        b1.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b2.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b3.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b4.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b5.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b6.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b7.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b8.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b9.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b10.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b11.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b12.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b13.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b14.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b15.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
        ...
        b16.gameObject.name = gameObject.name + "_" + Boss1Pattern1Damage;
    ...
    IEnumerator Pattern2()
    {
        ...
        {
            //위쪽
            transform.position = new Vector2(GameManager.Instance.Boss1Pos.transform.position.x, GameManager.Instance.Boss1Pos.transform.position.y + 8f);
        }
        else if (where == 2)
        {
            //아래
        ...
        {
            //오른쪽
            transform.position = new Vector2(GameManager.Instance.Boss1Pos.transform.position.x + 8f, GameManager.Instance.Boss1Pos.transform.position.y);
        }
        else if (where == 4)
        {
            //왼쪽
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            bossBullet.gameObject.name = gameObject.name + "_" + Boss1Pattern2Damage;
